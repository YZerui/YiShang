...
import com.yishang.E.view.dialog.BaseEffects;
...
public class MyDialog extends Dialog {
	...
	public MyDialog setRightBtnTextColor(int color){
		okBtn.setTextColor(color);
		return this;
	}
	public MyDialog setLeftBtnTextColor(int color){
