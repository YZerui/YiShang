...
public interface StickyListHeadersAdapter extends ListAdapter {
	...
	/**
	 * Get a View that displays the header data at the specified position in the set. You can either create a
	 * View manually or inflate it from an XML layout file.
	 * 
	 * @param position
	 *            The position of the item within the adapter's data set of the item whose header view we
	 *            want.
	 * @param convertView
	 *            The old view to reuse, if possible. Note: You should check that this view is non-null and of
