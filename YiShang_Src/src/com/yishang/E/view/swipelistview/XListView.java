...
public class XListView extends ListView implements OnScrollListener{
	...
	private boolean mPullRefreshing = true; // 是否刷新.
	// -- 底部的View
	...
	public void setPullRefreshEnable(boolean enable) {
		...
		if (!mEnablePullRefresh) { // 禁用,隐藏内容
			mHeaderViewContent.setVisibility(View.GONE);// 如果为false则隐藏下拉刷新功能
		} else {
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		if (mScrollListener != null&&view!=null) {
	...
	public void setMode(boolean loadAble, boolean refreshAble) {
		setPullLoadEnable(loadAble);
		setPullRefreshEnable(refreshAble);
	}
    ...
    public void setListMode(boolean ifRefresh,boolean ifLoad){
    	if(ifRefresh){
