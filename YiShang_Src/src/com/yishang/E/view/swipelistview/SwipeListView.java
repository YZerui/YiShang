...
package com.yishang.E.view.swipelistview;
 ...
 */
public class SwipeListView extends XListView implements IXListViewListener{
...
//        httpCallBack.initListView();
    ...
    /************************************网络请求加载回调*********************************/
    private listHttpCallBack httpCallBack;
    
    public void setHttpCallBack(listHttpCallBack httpCallBack){
    	this.httpCallBack=httpCallBack;
    	this.httpCallBack.initListView();
    }
    
	@Override
	public void onRefresh() {
		// TODO Auto-generated method stub
		httpCallBack.onRefresh();
	}

	@Override
	public void onLoadMore() {
		// TODO Auto-generated method stub
		httpCallBack.onLoadMore();
	}
	
	/*********************************列表样式属性设定************************************/
	public void setViewMode(boolean onRefresh,boolean onLoadMore,int swipeMode,int backUnitNum){
		setPullLoadEnable(onLoadMore);
		setPullRefreshEnable(onRefresh);
		setSwipeMode(swipeMode);
		setOffsetLeft(getResources().getDisplayMetrics().widthPixels * (5-backUnitNum) /5);
	}
