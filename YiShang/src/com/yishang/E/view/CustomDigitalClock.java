...
public class CustomDigitalClock extends DigitalClock {
			...
			public void run() {
				...
				if (distanceTime == 0) {
					...
					if(noteText!=null&&noteText.length()>0){
						setText("("+dealTime(distanceTime,mode)+")"+noteText);
					}else {
						setText(dealTime(distanceTime,mode));
					}
	 ...
	 * @return
	 */
	public static String dealTime(long time, int mode) {
	 ...
	 * @param endTime
	 */
	public void setEndTime(long endTime,int mode,String noteText) {
