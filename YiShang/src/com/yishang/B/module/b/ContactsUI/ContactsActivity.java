	...
	protected void onClickListener() {
		...
		topBar.setCallBack(new topBarCallBack() {
			...
			public void call_rightSecondClick() {
				...
				ViewSwitchUtils.tab_in2TopIntent(context, ContactsNewPhoneDialog.class);
			}
		});
				...
				dialog.withTitle("选择对 "+title)
					...
					.setCallBack(new callBack_Dialog() {
						...
						public void click_btn1() {
							...
							//转发文档
							// 分享操作
							ViewSwitchUtils.tab_in2TopIntent(context,ResourceSelectPage.class,
									bean.getRela_id());
						}
						@Override
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case RESULT_CONTACT_SELECT:
			...
			handler.postDelayed(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					DBRequest.setCallBack(callBack, ContactsFilterDialog.enumType)
						.callInit();
				}
			},Enum_Param.TIMEOFFSET_LISTLOAD.value());
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals(
				...
				topBar.setProVisibility(false).setTitle("人脉")
						.setRighTextVisibility(true).onRightSecondTextBtn_Text(true);
			}
		}
	}
